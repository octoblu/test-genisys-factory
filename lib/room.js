...
var meshblu_firehose = require ('meshblu-firehose-socket.io')
...
module.exports = class Room {
  ...
  //   meshblu.device(this.roomId, function(error, device){
  //     if (error) return error
  //     var skype = device.genisys.inSkype
  //     if (skype == false) {
  //       console.log ("Skype is not in a sessions")
  //     }
  //     if (skype == true) {
  //       console.log ("Skype is in a sessions")
  //     }
  //     return skype
  //   })
  // }
  ...
  isSkypeStarting(){
    firehose.connect(this.roomId, function(error, device){
      if (error) return error
      console.log(device);
    })
  }
